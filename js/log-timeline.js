/**
 * CPR Assist - Log Timeline Modul (V20 - Single Container Edition)
 * - Nutzt "protocol-list" als einzige Leinwand für alle 3 Tabs!
 * - Garantiert das Rendern von Zeitlinie, Liste und SBAR.
 * - Inklusive getrennter Icons für Adrenalin & Amiodaron.
 */
...
window.CPR.LogTimeline = (function() {
    ...
    function getIconData(txt) {
        ...
        if (t.includes('pause') || t.includes('fortgesetzt')) return null; // Pausen blenden wir für die Sauberkeit aus
    ...
    function renderSummary() {
        // Zielt exakt auf die einzige Box in der HTML!
        ...
        isRendering = true;
        // Padding Bottom (pb-12) stellt sicher, dass man bis zum Ende scrollen kann!
        container.innerHTML = `
            <div class="p-4 flex flex-col gap-3 bg-slate-50 min-h-full pb-12">
        ...
        `;
        isRendering = false;
        container.scrollTop = 0; // Springt beim Tab-Wechsel nach oben
    }
    ...
    function renderTimeline() {
        ...
        let html = `<div class="p-4 bg-slate-50 min-h-full pb-12">`;
        ...
        isRendering = false;
        container.scrollTop = container.scrollHeight; // Autoscroll ans Ende
    }
    ...
    function renderList() {
        ...
        let html = `<div class="bg-white min-h-full pb-12">`;
        events.forEach(item => {
    ...
    function switchTab(tab) {
        ...
        // Buttons umfärben (Weiß leuchtend = Aktiv, Grau = Inaktiv)
    ...
    function init() {
        // Exakte Bindung an die Button-IDs aus deiner HTML Datei
        ...
        // Wenn das Logbuch-Panel von unten hochfährt, Inhalt sofort rendern!
